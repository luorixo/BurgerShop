...
@RunWith(Suite.class)
@SuiteClasses({ BurgerShopTestSuite.Task1Test.class, BurgerShopTestSuite.Task2Test.class,
		BurgerShopTestSuite.Task3Test.class, BurgerShopTestSuite.Task4Test.class,
